        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea name="contenido" rows="4"
                    class="form-control">{{ old('contenido', $post->contenido) }}</textarea>
            </div>
            @error('contenido')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
            ...
            <div class="form-group">
                ...
                <select name="estatus" class="form-control">
                    <option value="borrador" {{ old('estatus', $post->estatus) == 'borrador' ? 'selected' : '' }}>
                        Borrador
                    </option>
                    <option value="publicado" {{ old('estatus', $post->estatus) == 'publicado' ? 'selected' : '' }}>
                        Publicado
                    </option>
                </select>
            </div>
