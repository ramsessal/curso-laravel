...
<body>
    <div class="tarjeta">
        ...
        <div class="acciones">
            <a href="{{ route('directorio.edit', ['empleado' => $empleado], false) }}">Editar</a>
            <a href="{{ route('directorio.index', [], false) }}">Volver al listado</a>

            <form method="POST" action="{{ route('directorio.destroy', ['empleado' => $empleado], false) }}" style="display: inline; margin-left: 10px;">
                @csrf
                @method('DELETE')
